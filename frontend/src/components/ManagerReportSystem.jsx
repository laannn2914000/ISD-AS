          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 gap-4">
              {reports.map((report) => (
                <div
                  key={report._id}
                  className="bg-white p-6 rounded-[24px] border border-gray-100 hover:shadow-lg transition-all flex items-center justify-between group"
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      <button
                        className="p-2.5 bg-gray-50 text-gray-400 rounded-xl hover:bg-gray-100"
