...
const Dashboard = () => {
  ...
  const [showLogoutModal, setShowLogoutModal] = useState(false); // Trạng thái hiển thị Pop-up đăng xuất
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  <tr className="text-sm">
                    ...
                    <td className="py-4 text-[#0061f2] font-bold cursor-pointer">
                      Xem
                    </td>
                  </tr>
                </tbody>
