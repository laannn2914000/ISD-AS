...
const Login = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-white font-sans overflow-hidden">
      {/* CỘT TRÁI: BANNER XANH GRADIENT & DECOR */}
      <div className="hidden lg:flex flex-col justify-center w-[60%] bg-gradient-to-tr from-[#0052cc] via-[#0061f2] to-[#0074e4] p-32 text-white relative">
        <div className="z-10 -mt-20">
          ...
          <button className="bg-[#1a8cff] hover:bg-white hover:text-[#0061f2] border border-white/20 px-10 py-3 rounded-full transition-all text-sm font-semibold shadow-lg w-fit active:scale-95">
            Đọc Thêm
          </button>
        </div>

        {/* Vòng tròn Decor chuẩn thiết kế */}
        <div className="absolute -bottom-24 -left-24 w-[600px] h-[600px] border border-white/10 rounded-full"></div>
        <div className="absolute -bottom-48 -left-10 w-[500px] h-[500px] border border-white/5 rounded-full"></div>
      </div>
      ...
      <div className="w-full lg:w-[40%] flex flex-col justify-center items-center px-16 lg:px-24">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              disabled={loading}
              className="w-full bg-[#0061f2] hover:bg-[#0052cc] text-white py-4.5 rounded-full font-bold text-lg shadow-[0_10px_25px_rgba(0,97,242,0.2)] transition-all flex justify-center items-center active:scale-[0.98] disabled:opacity-70"
            >
              {loading ? (
