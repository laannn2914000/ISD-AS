...
const EmployeeManagement = () => {
  ...
  const handleCreateEmployee = async (e) => {
    ...
    console.log("Creating employee with data:", newEmp);
    try {
  ...
  const handleToggleLock = async () => {
    ...
    try {
      await axios.patch(
        `${API_URL}/api/users/toggle-lock/${lockModal._id}`,
        {},
        getAuthHeader(),
      );
        ...
        <header className="h-[88px] bg-white border-b border-gray-100 flex items-center px-10 sticky top-0 z-10 shadow-sm">
          <div className="relative flex-1 max-w-2xl text-left">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-3.5 bg-gray-50 rounded-full outline-none focus:ring-1 focus:ring-yellow-400 text-sm"
              value={searchTerm}
        ...
        <main className="p-10 space-y-6">
          ...
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-yellow-400 text-white rounded-xl font-bold hover:bg-yellow-500 shadow-md transition-all active:scale-95"
            >
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center justify-center gap-2">
                        <button
                          ...
                          className="p-2 text-gray-400 hover:bg-yellow-100 rounded-lg"
                        >
                          <Eye size={18} />
                        </button>
                        <button
          ...
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl">
            ...
            <p className="text-gray-500 text-sm mb-4">
              ...
              <span className="font-bold text-gray-800">
                {lockModal.fullName || lockModal.name}
              </span>{" "}
              để xác nhận.
            </p>
            <input
              type="text"
              className="w-full px-4 py-3 bg-gray-50 border rounded-xl outline-none focus:ring-2 focus:ring-yellow-400 mb-6"
              value={confirmName}
...
const NavItem = ({ icon, label, active = false, onClick }) => (
  <div
    onClick={onClick}
    className={`flex items-center gap-4 px-4 py-3.5 rounded-xl cursor-pointer transition-all ${active ? "bg-white text-yellow-500 font-bold shadow-sm" : "text-gray-800 hover:bg-black/10 font-normal"}`}
  >
    ...
    >
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            type="text"
            className={`w-full mt-1 px-5 py-3 bg-gray-50 border ${errors.fullName ? "border-red-500" : "border-gray-100"} rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400`}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="email"
              className={`w-full mt-1 px-5 py-3 bg-gray-50 border ${errors.email ? "border-red-500" : "border-gray-100"} rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400`}
              value={data.email || ""}
          ...
          <div>
            ...
            <input
              type="text"
              className={`w-full mt-1 px-5 py-3 bg-gray-50 border ${errors.phone ? "border-red-500" : "border-gray-100"} rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400`}
              value={data.phone || ""}
        ...
        {!isEdit && (
          <div>
            ...
            />
            {errors.password && (
              <p className="text-red-500 text-[11px] mt-1 ml-2 font-medium leading-tight">
                {errors.password}
              </p>
            )}
          </div>
      ...
      <div className="flex gap-3 mt-10">
        ...
        <button
          type="submit"
          className="flex-1 py-3.5 bg-yellow-400 text-white font-bold rounded-2xl shadow-lg active:scale-95 transition-all"
        >
          Xác nhận
        </button>
      </div>
