...
const NavItem = ({
  ...
  <div
    ...
    className={`flex items-center gap-4 px-4 py-3.5 rounded-xl transition-all ${disabled ? "cursor-not-allowed" : active ? "bg-white text-yellow-500 font-bold shadow-sm" : "text-gray-800 hover:bg-black/10 font-normal cursor-pointer"}`}
  >
